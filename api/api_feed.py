...
class ApiFeed(ApiBase):
    ...
    async def _zanzone(self, target_qq: int, g_tk: int, fid: int, cur_key: str, uni_key:str, cookies: Union[str, Dict]) -> Optional[Dict[str, Any]]:
        """点赞指定说说"""
        try:
    ...
    async def _send_zone(self, target_qq: int, content: str, cookies: Union[str, Dict], g_tk:int) -> Optional[Dict[str, Any]]:
        """发送文本说说"""
        try:
            ...
            return None
    async def _forward_zone(self, target_qq: int,opuin:int, tid: str,connect:str, cookies: Union[str, Dict],g_tk:int) -> Optional[Dict[str, Any]]:
        """转发说说"""
        try:
            ...
            return None
    async def _del_zone(self, target_qq: int, fid: str, cookies: Union[str, Dict],g_tk:int,curkey:str,timestamp:int) -> Optional[Dict[str, Any]]:
        """删除说说"""
        try:
            ...
            return None
    async def _send_comments(self, target_qq: int,uin:int, content: str, cookies: Union[str, Dict],g_tk:str,fid:str) -> Optional[Dict[str, Any]]:
        """发送评论"""
        try:
